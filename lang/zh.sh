...
TXT_REGIONS_OTHER_THAN_CHINA="对于中国大陆以外的地区，无需更改源"
...
TXT_SYSTEM_ARCHITECTURE="暂不支持的系统架构，请参阅官方文档，选择受支持的系统。"
TXT_INSTALLATIO_MODE="请输入正确的安装模式（dev or stable）"
TXT_OBTAIN_VERSION_FAIELD="获取最新版本失败，请稍候重试"
TXT_INSTALLATION_PACKAGE_HASH="安装包已存在，跳过下载"
TXT_INSTALLATION_PACKAGE_ERROR="已存在安装包，但是哈希值不一致，开始重新下载"
TXT_START_DOWNLOADING_PANEL="开始下载 1Panel"
TXT_INSTALLATION_PACKAGE_DOWNLOAD_ADDRESS="安装包下载地址："
TXT_INSTALLATION_PACKAGE_DOWNLOAD_FAIL="下载安装包失败，请稍候重试"
