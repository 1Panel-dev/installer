...
LOW_DOCKER_VERSION="检测到服务器Docker版本低于20.x，建议手动升级以避免功能受限。"
...
INSTALLATION_PACKAGE_HASH="安装包已存在，跳过下载"
INSTALLATION_PACKAGE_ERROR="已存在安装包，但是哈希值不一致，开始重新下载"
...
PANEL_SERVICE_USER_INFO="获取 1Panel 用户信息"
PANEL_SERVICE_LISTEN_IP="切换 1Panel 监听 IP"
PANEL_SERVICE_VERSION="查看 1Panel 版本信息"
PANEL_SERVICE_UPDATE="修改 1Panel 系统信息"
PANEL_SERVICE_RESET="重置 1Panel 系统信息"
PANEL_SERVICE_RESTORE="恢复 1Panel 服务及数据"
PANEL_SERVICE_UNINSTALL_NOTICE="卸载将会完全清除 1Panel 服务和数据目录，是否继续[y/n] "
PANEL_SERVICE_UNINSTALL_START="开始卸载 1Panel Linux 服务器运维管理面板"
...
PANEL_SERVICE_RESTORE_NOTICE="1Panel 将会恢复至上一个稳定版本，是否继续 [y/n] "
PANEL_SERVICE_UNSUPPORTED_PARAMETER="不支持的参数，请使用 help 或 --help 参数获取帮助"
PANEL_CONTROL_SCRIPT="1Panel 控制脚本"
LANG_SELECTED_MSG="已选择语言："
LANG_PROMPT_MSG="请选择一种语言："
LANG_CHOICE_MSG="请输入与您的语言对应的数字："
LANG_SELECTED_CONFIRM_MSG="您选择了："
LANG_INVALID_MSG="无效的选择，默认切换为英语。"
LANG_NOT_FOUND_MSG="未找到语言文件："
