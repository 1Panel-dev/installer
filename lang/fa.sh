...
DOCKER_ALREADY_INSTALLED="docker ghablan nasb shode ast, marhale nasb rad mishavad"
...
INSTALLATION_PACKAGE_ERROR="baste nasb az ghabl vojud darad. daryaft rad mishavad."
INSTALLATION_PACKAGE_HASH="baste nasb az ghabl vojud darad, ama meghdare hash hamkhani nadarad. daryaft dobare shoro mishavad"
...
PANEL_SERVICE_RESTORE="1Panel be akharin version paydar bar migardad. Ay khahesh darid edame dahid? [y/n]"
...
LANGUAGE_CONFIG_FAIELD="[KHATA] File tanzim zaban yaft nashod."
LANGUAGE_CONFIG_NOT_FOUND="[KHATA] File zaban yaft nashod:"
