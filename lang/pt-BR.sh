...
TXT_APPSTORE_OFFLINE_INSTALL="Pacote offline da App Store detectado. Copiando para o diretório de recursos do 1Panel..."
TXT_APPSTORE_OFFLINE_SUCCESS="Pacote offline da App Store copiado com sucesso."
TXT_APPSTORE_OFFLINE_FAIL="Falha ao copiar o pacote offline da App Store."
