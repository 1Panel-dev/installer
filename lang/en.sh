...
TXT_APPSTORE_OFFLINE_INSTALL="App Store offline package detected. Copying to the 1Panel resource directory..."
TXT_APPSTORE_OFFLINE_SUCCESS="App Store offline package copied successfully."
TXT_APPSTORE_OFFLINE_FAIL="Failed to copy the App Store offline package."
