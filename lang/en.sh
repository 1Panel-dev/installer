...
TXT_REGIONS_OTHER_THAN_CHINA="For regions other than Mainland China, no need to change the source"
...
TXT_PROJECT_OFFICIAL_WEBSITE="Official website: https://1panel.cn"
TXT_PROJECT_DOCUMENTATION="Project documentation: https://1panel.cn/docs"
...
TXT_SYSTEM_ARCHITECTURE="The system architecture is not currently supported. Please refer to the official documentation to select a supported system."
TXT_INSTALLATIO_MODE="Please enter the correct installation mode (dev or stable)"
TXT_OBTAIN_VERSION_FAIELD="Failed to obtain the latest version, please try again later"
TXT_INSTALLATION_PACKAGE_HASH="The installation package already exists. Skip downloading."
TXT_INSTALLATION_PACKAGE_ERROR="The installation package already exists, but the hash value is inconsistent. Start downloading again"
TXT_START_DOWNLOADING_PANEL="Start downloading 1Panel"
TXT_INSTALLATION_PACKAGE_DOWNLOAD_ADDRESS="Installation package download address:"
TXT_INSTALLATION_PACKAGE_DOWNLOAD_FAIL="Failed to download the installation package"
